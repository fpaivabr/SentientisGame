...
func _ready():
	if dialog_box:
		...
		print("Erro: DialogBox não encontrado no nó ElectricalCircuit")  # Debug para problemas
...
func show_dialog():
	if dialog_box:
		...
		dialog_box.get_node("Label").text = "Você observa o circuito elétrico. Parece que há algo errado."
	else:
